...
```jsx caption="onBlur 이벤트를 활용한 아이디 중복 검사 예시"
useEffect(() => {
...
<ArchitectureImage
  src="/resources/img/projects/e4-edu-web/tbgoods-custom-sequence_code.png"
  alt="커스텀 시퀀스 일일 초기화 코드"
  caption="커스텀 시퀀스 일일 초기화 로직"
/>
