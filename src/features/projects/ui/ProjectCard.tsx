...
export const ProjectCard = memo<ProjectCardProps>(({ project }) => {
  return (
    <Card
      variant="elevated"
      padding="none"
      className="group overflow-hidden hover:shadow-xl transition-all duration-normal"
    >
      {/* Project Image */}
      <div className="relative overflow-hidden">
        <ImagePlaceholder
          aspectRatio="video"
          label={project.title}
          className="rounded-none transition-transform duration-slow group-hover:scale-105"
        />
