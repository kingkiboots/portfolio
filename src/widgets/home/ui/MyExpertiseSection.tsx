...
const expertiseItems = [
  {
    ...
    underlineColor: "bg-secondary/50",
    description:
      "Bridging backend foundations with frontend expertise to architect holistic systems.",
  },
  {
    id: "frontend",
    icon: (
    ...
    description:
      "Passionate about UI/UX and performance optimization, with over 3 years of React experience.",
  },
  {
    id: "dx",
    icon: (
    ...
    underlineColor: "bg-warning/60",
    description:
      "Skilled in enhancing developer experience through build tools, testing frameworks, and clear documentation.",
  },
];
        ...
        {expertiseItems.map((item) => (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h3 className="mb-1">
                <span className="text-foreground relative z-10 inline-block text-xl font-bold">
                  {item.title}
                  <span
                    className={`absolute bottom-0.5 left-0 -z-10 h-2 w-full -skew-x-3 ${item.underlineColor}`}
                    aria-hidden="true"
                  />
                </span>
